...
class ProductSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final shopInfo = ref.read(individualStoreProvider);

    List<RecycleProductModel> recycleDataList = [];

    return shopInfo.storeStatus != "Verified"
        ? Center(
            child: Text(
              shopInfo.storeStatus == "Terminated"
                  ? "Store Permanently Terminated"
                  : "Store under Verification.Please Wait",
        ...
        : SizedBox(
            ...
            child: StreamBuilder(
              stream: FirebaseFirestore.instance
                  ...
                  .where('shopID', isEqualTo: shopInfo.id)
                  .snapshots(),
